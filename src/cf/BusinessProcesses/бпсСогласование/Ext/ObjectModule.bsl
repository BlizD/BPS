		...
		Если ЗначениеЗаполнено(СтрокаОпределениеЛистаСогласования.АлгоритмНахожденияСогласователей) Тогда
			...
			Если Согласователь = Неопределено Тогда
				Если СтрокаОпределениеЛистаСогласования.ПропускатьЕслиНеЗаданАдресат Тогда
					ПротоколФормированияЛистаСогласования = ПротоколФормированияЛистаСогласования 
					+ "Алгоритм поиска согласователя № "+СтрокаОпределениеЛистаСогласования.НомерСтроки+" ["+СокрЛП(СтрокаОпределениеЛистаСогласования.АлгоритмНахожденияСогласователей)+"] не нашёл пользователя, поэтому не добавляем рецензента"+Символы.ПС;			
					Продолжить;
				Иначе
					Отказ = Истина;
					ВызватьИсключение("Алгоритм поиска согласователя № "+СтрокаОпределениеЛистаСогласования.НомерСтроки+" ["+СокрЛП(СтрокаОпределениеЛистаСогласования.АлгоритмНахожденияСогласователей)+"] не нашёл пользователя, поэтому не запускаем согласование"+Символы.ПС);
					Продолжить;
				Конецесли;	
			Конецесли;	
		Конецесли;	
